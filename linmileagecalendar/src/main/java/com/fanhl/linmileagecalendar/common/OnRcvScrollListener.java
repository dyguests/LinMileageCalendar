 ...
 * @date 2015/4/6
 */
public class OnRcvScrollListener extends RecyclerView.OnScrollListener implements OnBottomListener, OnTopListener {
    public static final String TAG = OnRcvScrollListener.class.getSimpleName();
